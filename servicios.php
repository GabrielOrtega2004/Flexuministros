...
<section class="section section--tight svc-brands">
  <div class="container">
    ...
    <div class="grid grid--2" style="max-width:44rem;margin-inline:auto">
      ...
      <div class="card">
        <img class="svc-brands__logo" src="/uploads/marcas_servicio/<?= esc($m['logo']) ?>" width="611" height="160" alt="<?= esc($m['nombre']) ?>" loading="lazy" decoding="async" <?= $m['nombre'] === 'Aalberts Surface Technologies' ? 'style="height:3.75rem"' : '' ?>>
        <h3><?= esc($m['nombre']) ?></h3>
